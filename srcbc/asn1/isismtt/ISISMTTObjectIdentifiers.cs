namespace emCastle.Asn1.IsisMtt
{
	public abstract class IsisMttObjectIdentifiers
	{
		 ...
		 * </pre>
		 * 
		 * @see emCastle.Asn1.IsisMtt.X509.Restriction
		 */
		 ...
		 * 
		 * @see emCastle.Asn1.IsisMtt.Ocsp.RequestedCertificate
		 */
		 ...
		 *
		 * @see emCastle.Asn1.IsisMtt.Ocsp.CertHash
		 */
		 ...
		 * 
		 * Used in
		 * {@link emCastle.Asn1.X509.SubjectDirectoryAttributes SubjectDirectoryAttributes}
		 */
		 ...
		 * </pre>
		 * 
		 * @see emCastle.Asn1.IsisMtt.X509.AdditionalInformationSyntax
		 */
