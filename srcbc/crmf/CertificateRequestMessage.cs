...
namespace emCastle.Crmf
{
    ...
    {
        public static readonly int popRaVerified = emCastle.Asn1.Crmf.ProofOfPossession.TYPE_RA_VERIFIED;
        public static readonly int popSigningKey = emCastle.Asn1.Crmf.ProofOfPossession.TYPE_SIGNING_KEY;
        public static readonly int popKeyEncipherment = emCastle.Asn1.Crmf.ProofOfPossession.TYPE_KEY_ENCIPHERMENT;
        public static readonly int popKeyAgreement = emCastle.Asn1.Crmf.ProofOfPossession.TYPE_KEY_AGREEMENT;
