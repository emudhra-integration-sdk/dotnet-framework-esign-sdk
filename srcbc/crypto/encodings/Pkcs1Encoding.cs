...
namespace emCastle.Crypto.Encodings
{
    /**
    ...
    */
        ...
        : IAsymmetricBlockCipher
    {
         ...
         * work with one of these set the system property emCastle.Pkcs1.Strict to false.
         */
        public const string StrictLengthEnabledProperty = "emCastle.Pkcs1.Strict";
