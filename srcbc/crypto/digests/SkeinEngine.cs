...
namespace emCastle.Crypto.Digests
{

    /// <summary>
    /// Implementation of the Skein family of parameterised hash functions in 256, 512 and 1024 bit block
    /// sizes, based on the <see cref="emCastle.Crypto.Engines.ThreefishEngine">Threefish</see> tweakable block cipher.
    /// </summary>
    /// <remarks>
    ...
    /// <p/>
    /// This implementation is the basis for <see cref="emCastle.Crypto.Digests.SkeinDigest"/> and <see cref="emCastle.Crypto.Macs.SkeinMac"/>, implementing the
    /// parameter based configuration system that allows Skein to be adapted to multiple applications. <br/>
    /// Initialising the engine with <see cref="emCastle.Crypto.Parameters.SkeinParameters"/> allows standard and arbitrary parameters to
    ...
    /// </ul>
    /// </remarks>
    /// <seealso cref="emCastle.Crypto.Parameters.SkeinParameters"/>
        ...
        : IMemoable
    {
        ...
        /// <summary>
        /// Initialises the Skein engine with the provided parameters. See <see cref="emCastle.Crypto.Parameters.SkeinParameters"/> for
