...
namespace emCastle.Crypto.Macs
{

	/// <summary>
	/// Implementation of the Skein parameterised MAC function in 256, 512 and 1024 bit block sizes,
	/// based on the <see cref="emCastle.Crypto.Engines.ThreefishEngine">Threefish</see> tweakable block cipher.
	/// </summary>
	/// <remarks>
	...
	/// </remarks>
	/// <seealso cref="emCastle.Crypto.Digests.SkeinEngine"/>
		...
		: IMac
	{
		...
		/// </summary>
		/// See <see cref="emCastle.Crypto.Parameters.SkeinParameters"></see> for details on the parameterisation of the Skein hash function.
