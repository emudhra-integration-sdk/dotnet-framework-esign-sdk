...
using System.util;
using eSignLibrary.text.log;
using eSignLibrary.text.pdf.events;
using eSignLibrary.text.pdf.interfaces;
using eSignLibrary.text.pdf.intern;
using eSignLibrary.text.pdf.collection;
using eSignLibrary.text.xml.xmp;
using eSignLibrary.xmp.options;
using emCastle.X509;
using eSignLibrary.text.error_messages;
using eSignLibrary.xmp;
        ...
        */
        virtual protected internal PdfIndirectReference GetReferenceJBIG2Globals(byte[] content) {
            ...
            foreach (PdfStream str in JBIG2Globals.Keys) {
                if (emCastle.Utilities.Arrays.AreEqual(content, str.GetBytes())) {
