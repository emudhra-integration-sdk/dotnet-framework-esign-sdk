...
namespace eSignLibrary.text.pdf.codec.wmf {
    public class MetaFont : MetaObject {
        ...
        virtual public BaseFont Font {
            get {
                if (font != null)
                    return font;
                eSignLibrary.text.Font ff2 = FontFactory.GetFont(faceName, BaseFont.CP1252, true, 10, ((italic != 0) ? eSignLibrary.text.Font.ITALIC : 0) | ((bold != 0) ? eSignLibrary.text.Font.BOLD : 0));
                font = ff2.BaseFont;
                if (font != null)
                    return font;
                string fontName;
