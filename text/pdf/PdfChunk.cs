...
namespace eSignLibrary.text.pdf {
    ...
    public class PdfChunk {
        ...
        internal PdfChunk(Chunk chunk, PdfAction action) {
            ...
            Font f = chunk.Font;
            float size = f.Size;
            if (size == eSignLibrary.text.Font.UNDEFINED)
                size = 12;
            baseFont = f.BaseFont;
            //BaseFont bf = f.BaseFont;
            int style = f.Style;
            if (style == eSignLibrary.text.Font.UNDEFINED) {
                style = eSignLibrary.text.Font.NORMAL;
            }
            if (baseFont == null) {
